...
BASIC_LOGDIR="/Users/dcalifornia/baselines/experiment_logs/rd"
...
do
    ...
    python3 -m baselines.run --alg=deepq --env=graph-search-rd-v0 --env_kwargs=$str_kwargs  --num_timesteps=2e3 --print_freq=10
